...
!OUTPUT DIR
OutputDir =	"~/FortranOutputDir/MXtry1/"
...
MatchRelativeToTargetOutput	= 0 !use for no labor supply option
ImposeEqumInCalibration 		= 0

!adjustment cost options
OneAssetNoCapital			= 0
PinKappa1ByKappa02 		= 0
...
MatchMedianIll  = 0
MatchP75Ill			= 0
MatchFracIll0		= 0 !Shouldn't this be equal to one
MatchMeanLiq		= 1
MatchMedianLiq  = 0
MatchFracLiq0		= 1
MatchFracLiqNeg = 1
...
!=======================================================
!discount rates
rho		=  1.760896858648569E-002!0.015 !0.01272892513 !0.0818 !0.01272892513(baseline), 0.0133348071(frisch=0.5), 0.0123887061(frisch=1.5), 0.0125456234 (ghh)


!preferences
deathrate	= 1.0/150.0!1.0/(4.0*45.0) !poisson death rate
gam				= 1.0	!risk aversion
prefshock	= 1.0


!liquid assets
rb					= 0.025/4.0 !liquid return
...
!withdrawal costs
kappa0_w	= 8.866261638040071E-002!0.04383
kappa2_w	= 6.055910350823953E-002!0.40176
kappa3		= 0.0!0.03 *2.92/4.0 !as a fraction of average illiquid assets
kappa4_w 	= 0.0

IF(PinKappa1ByKappa02==0) kappa1_w	=   8.198069654434172E-002!0.48236
...
!government
labtax 		= 0.2!0.30
lumptransferpc = 0.004!40000*labtax/(115000.0*2.92*4.0)
! lumptransfer = 0.10
corptax 		= 0.0
