...
!OUTPUT DIR
OutputDir =	"~/FortranOutputDir/MXtry0/"
...
!discount rates
rho		=  0.015 !0.01272892513 !0.0818 !0.01272892513(baseline), 0.0133348071(frisch=0.5), 0.0123887061(frisch=1.5), 0.0125456234 (ghh)
