...
real(8), parameter   :: agridparam = 0.35!0.35!0.15 !0.9 !0.15		!for a: approaches linear as goes to 1, approaches L shaped as goes to 0
real(8), parameter   :: bgridparam = 0.3!0.35 !0.25 !0.35		!for b pos: approaches linear as goes to 1, approaches L shaped as goes to 0
...
real(8), parameter   :: bmax  = 200.0!40.0 !500.0 !40.0
