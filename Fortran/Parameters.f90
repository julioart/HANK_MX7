...
integer,parameter :: ngpbPOS	= 60 !60		    !grid for liquid assets, >=0 range
integer,parameter :: ngpbNEG	= 20		    !grid for liquid assets, <0 range only active if Borrowing==1
...
real(8), parameter   :: agridparam = 0.25!0.35!0.15 !0.9 !0.15		!for a: approaches linear as goes to 1, approaches L shaped as goes to 0
real(8), parameter   :: bgridparam = 0.25!0.35 !0.25 !0.35		!for b pos: approaches linear as goes to 1, approaches L shaped as goes to 0
real(8), parameter   :: bgridparamNEG = 0.2		!for b neg: approaches linear as goes to 1, approaches L shaped as goes to 0
real(8), parameter   :: amax  = 300.0!1000!1500.0!2000.0 !0.1 !2000.0			!multiple of quarterly output
